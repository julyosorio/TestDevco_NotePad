...
public class SelectAndNoAuthorize implements Task {
    ...
    public SelectAndNoAuthorize(InfoTrx infoTrx){
    ...
    public static SelectAndNoAuthorize pendingTransactions(InfoTrx infoTrx) {
        return Tasks.instrumented(SelectAndNoAuthorize.class, infoTrx);
    }
}
