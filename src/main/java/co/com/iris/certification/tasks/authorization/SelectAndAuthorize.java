...
public class SelectAndAuthorize implements Task {
    ...
    public SelectAndAuthorize(InfoTrx infoTrx){
    ...
    public static SelectAndAuthorize pendingTransactions(InfoTrx infoTrx){
        return Tasks.instrumented(SelectAndAuthorize.class, infoTrx);
    }
}
